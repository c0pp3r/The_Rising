...
DB_HOME=/home/vagrant/workspace/Core3/MMOCoreORB/bin/databases
export DB_HOME

# backup dir (should be on another filesystem)
DB_BACKUP=/home/vagrant/backups/onDemand
export DB_BACKUP
...
MYSQLDUMP="/usr/bin/mysqldump --user=root --password=123456 "
export MYSQLDUMP
