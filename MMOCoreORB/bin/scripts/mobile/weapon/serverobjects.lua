...
includeFile("weapon/groups/dark_jedi_weapons_gen4_onehand.lua")
includeFile("weapon/groups/dark_jedi_weapons_gen4_twohand.lua")
includeFile("weapon/groups/dark_jedi_weapons_gen4_polearm.lua")
