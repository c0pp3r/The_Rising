...
yivvits_start = ConvoScreen:new {
  id = "start",
  leftDialog = "",
  customDialogText = "Hello. Are you in need of Bounty Hunter Armor? If so, you've come to the right place.",
...
yivvits_shop = ConvoScreen:new {
  id = "shop",
  leftDialog = "",
  customDialogText = "These are all refurbished Armor Pieces, not so great, but they'll give you the experience you need to advance in your chosen profession.", 
  stopConversation = "false",
  options = { 
  }
}
...
yivvits_nope = ConvoScreen:new {
  id = "nope",
  leftDialog = "",
  customDialogText = "Rude to a Wookiee who's selling Armor... Are you brave or stupid?",
  stopConversation = "true",
  options = { 
  }
}
