...
crazylarry_start = ConvoScreen:new {
  id = "start",
  leftDialog = "",
  customDialogText = "Welcome to Crazy Larry's Luxury shop! I'm Crazy Larry!",
  stopConversation = "false",
  options = {
  	{"Hi, nice to meet you Larry any Luxury Houses in stock?", "banter1"},
  }
}
...
crazylarry_banter2 = ConvoScreen:new {
  id = "banter2",
  leftDialog = "",
  customDialogText = "I'm Crazy Larry probably one of the only guys around now adays that crafts Luxury Homes. I take it your here to buy a Luxury Home?",
  stopConversation = "false",
  options = {
...
crazylarry_banter4 = ConvoScreen:new {
  id = "banter4",
  leftDialog = "",
  customDialogText = "I dunno... since we left Nym's and started our own thing here, you guys have done great with the pirating without me. I'm happy enough just fixing and selling House's.",
  stopConversation = "false",
  options = {
