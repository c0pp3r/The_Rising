...
mlolemo_shop = ConvoScreen:new {
  id = "shop",
  leftDialog = "",
  customDialogText = "Yes, mesa be selling all kinds of the Mandalorian Armor. Well, technically some were first made by wesa Gungans on Rori, but yousa not be needed to know 'bout that mesa speck. See anything yousa like?",
  stopConversation = "false",
  options = { 
  }
}
...
mlolemo_banter1a = ConvoScreen:new {
  ...
  stopConversation = "false",
  options = {
	{"Would you look at the time! I really need to see the Mandalorian Armor Set.", "shop"}
  }
}
