...
nalyaro_shop = ConvoScreen:new {
  id = "shop",
  leftDialog = "",
  customDialogText = "This stuff is almost top of the line. 75% resists to everything except them laser swords, which ya never see nomore nohow. Can slice'm real good too.", 
  stopConversation = "false",
  options = { 
  }
}
