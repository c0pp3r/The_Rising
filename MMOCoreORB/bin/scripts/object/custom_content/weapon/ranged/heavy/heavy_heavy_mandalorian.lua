...
object_weapon_ranged_heavy_heavy_heavy_mandalorian = object_weapon_ranged_heavy_shared_heavy_heavy_mandalorian:new {
...
ObjectTemplates:addTemplate(object_weapon_ranged_heavy_heavy_heavy_mandalorian, "object/weapon/ranged/heavy/heavy_heavy_mandalorian.iff")
