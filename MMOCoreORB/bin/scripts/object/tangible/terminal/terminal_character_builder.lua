		...
		"Items",
		{
			...
			"Clothing",
			{
				"Crafting Aprons",
				{
					...
					"Jedi Crafting", "crafting_apron_jedi_saber",
					"Jedi Combat", "testing_combat_jedi",
					"Jedi Powers", "testing_combat_jedi_ranged",
					"god", "testing_god",
					"Entertainer", "testing_entertainer",
					"Medic", "testing_medic",
					"Melee Combat", "testing_combat_melee",
					"Ranged Combat", "testing_combat_ranged"
				},
				"Backpacks",
				{
				...
				"Robes",
				{
					"Exar Cultist (Down)", "object/tangible/wearables/robe/exar_cultist_hood_down.iff",
					"Exar Cultist (Up)", "object/tangible/wearables/robe/exar_cultist_hood_up.iff",
					"Shatterpoint Cloak", "object/tangible/wearables/robe/robe_s33.iff",
					"Cloak of Hate", "object/tangible/wearables/robe/robe_s32.iff",
					"Chronicler Robe (Tailor Buff)", "object/tangible/wearables/robe/robe_chronicle_master.iff"
				},
			},
			"Attachments",
			{
				"Armor",
					{
						"A-C",
						{
							"Additional Pets", "attachment_aa_keep_creature",
							"Advanced Assembly", "attachment_aa_advanced_assembly",
							"Advanced Camping", "attachment_aa_camp_advanced",
							"Advanced Component Experimentation", "attachment_aa_advanced_ship_experimentation",
							"Advertising", "attachment_aa_advertising",
							"Alertness", "attachment_aa_alert",
							"Anti-Blind", "attachment_aa_anti_blind",
							"Anti-Dizzy", "attachment_aa_anti_dizzy",
							"Anti-Intimidate", "attachment_aa_anti_intimidate",
							"Anti-Shock", "attachment_aa_anti_shock",
							"Anti-Stun", "attachment_aa_anti_stun",
							"Armor Assembly", "attachment_aa_armor_assembly",
							"Armor Complexity", "attachment_aa_armor_complexity",
							"Armor Customization", "attachment_aa_armor_customization",
							"Armor Experimentation", "attachment_aa_armor_experimentation",
							"Armor Repair", "attachment_aa_armor_repair",
							"Artisan Assembly", "attachment_aa_general_assembly",
							"Artisan Clothing Customization", "attachment_aa_artisan_clothing_customization",
							"Artisan Experimentation", "attachment_aa_general_experimentation",
							"Basic (Comprehension)", "attachment_aa_language_basic_comprehend",
							"Basic (Speech)", "attachment_aa_language_basic_speak",
							"Battle Fatigue Healing (Dancing)", "attachment_aa_healing_dance_shock",
							"Battle Fatigue Healing (Music)", "attachment_aa_healing_music_shock",
							"Berserk", "attachment_aa_berserk",
							"Bio-Engineer Assembly", "attachment_aa_bio_engineer_assembly",
							"Bio-Engineer Experimentation", "attachment_aa_bio_engineer_experimentation",
							"Bleeding Absorption", "attachment_aa_absorption_bleeding",
							"Bleeding Dissipation", "attachment_aa_dissipation_bleeding",
							"Bleeding Resistance", "attachment_aa_resistance_bleeding",
							"Block", "attachment_aa_block",
							"Bodyform", "attachment_aa_body",
							"Booster Assembly", "attachment_aa_booster_assembly",
							"Booster Experimentation", "attachment_aa_booster_experimentation",
							"Bothese (Comprehension)", "attachment_aa_language_bothan_comprehend",
							"Bothese (Speech)", "attachment_aa_language_bothan_speak",
							"Bothese", "attachment_aa_language_bothan",
							"Bounty Mission Difficulty", "attachment_aa_bounty_mission_level",
							"Bribery", "attachment_aa_persuade_bribe",
							"Burst Run Efficiency", "attachment_aa_burst_run",
							"Business Acumen", "attachment_aa_business_acumen",
							"Camouflage", "attachment_aa_camouflage",
							"Camping - Repel Creatures", "attachment_aa_camprepelcreature",
							"Camping", "attachment_aa_camp",
							"Carbine Accuracy While Kneeling", "attachment_aa_carbine_kneeling",
							"Carbine Accuracy While Moving", "attachment_aa_carbine_hit_while_moving",
							"Carbine Accuracy While Prone", "attachment_aa_carbine_prone",
							"Carbine Accuracy While Standing", "attachment_aa_carbine_standing",
							"Carbine Accuracy", "attachment_aa_carbine_acccuracy",
							"Carbine Accuracy", "attachment_aa_carbine_accuracy",
							"Carbine Aiming", "attachment_aa_carbine_aim",
							"Carbine Counterattacks", "attachment_aa_carbine_counterattack",
							"Carbine Damage", "attachment_aa_carbine_damage",
							"Carbine Speed", "attachment_aa_carbine_speed",
							"Chassis Assembly", "attachment_aa_chassis_assembly",
							"Chassis Experimentation", "attachment_aa_chassis_experimentation",
							"Chassis/Armor Reverse Engineering", "attachment_aa_engineering_reverse",
							"Clothing Assembly", "attachment_aa_clothing_assembly",
							"Clothing Complexity", "attachment_aa_clothing_complexity",
							"Clothing Customization", "attachment_aa_clothing_customization",
							"Clothing Experimentation", "attachment_aa_clothing_experimentation",
							"Clothing Repair", "attachment_aa_clothing_repair",
							"Combat Bleeding Defense", "attachment_aa_combat_bleeding_defense",
							"Combat Equilibrium", "attachment_aa_combat_equilibrium",
							"Combat Equilibrium", "attachment_aa_combat_equillibrium",
							"Combat Haste", "attachment_aa_combat_haste",
							"Combat Medic Effectiveness", "attachment_aa_combat_medic_effectiveness",
							"Combat Medicine Assembly", "attachment_aa_combat_medicine_assembly",
							"Combat Medicine Experimentation", "attachment_aa_combat_medicine_experimentation",
							"Combat Medicine Use", "attachment_aa_combat_healing_ability",
							"Contraband Concealment", "attachment_aa_conceal_contraband",
							"Counterattack", "attachment_aa_counterattack",
							"Cover", "attachment_aa_take_cover",
							"Cover", "attachment_aa_takecover",
							"Crafting Medicine Complexity", "attachment_aa_medicine_complexity",
							"Crafting Technique", "attachment_aa_force_failure_reduction",
							"Creature Assembly", "attachment_aa_creature_assembly",
							"Creature Empathy", "attachment_aa_creature_empathy",
							"Creature Experimentation", "attachment_aa_creature_experimentation",
							"Creature Harvesting", "attachment_aa_creature_harvesting",
							"Creature Knowledge", "attachment_aa_creature_knowledge",
							"Creature Knowledge", "attachment_aa_creatureknowledge",
							"Creature Management", "attachment_aa_creature_management",
							"Creature Taming Bonus", "attachment_aa_tame_bonus",
							"Creature To-Hit Bonus", "attachment_aa_creature_hit_bonus",
							"Creature Tracking", "attachment_aa_track_creature",
							"Creature Tracking", "attachment_aa_trackcreature",
							"Creature Training", "attachment_aa_creature_training",
							"Creature Wound Healing", "attachment_aa_heal_creature_wound"
						},
						"D-F",
						{
						"Damage Healing", "attachment_aa_general_damage",
						"Dance Knowledge", "attachment_aa_healing_dance_ability",
						"Dancing Mind Enhancement", "attachment_aa_healing_dance_mind",
						"Dark Force: Envy", "attachment_aa_frs_dark_envy",
						"Dark Force: Suffering", "attachment_aa_frs_dark_suffering",
						"Dark Force: Vengeance", "attachment_aa_frs_dark_vengeance",
						"Defense Reverse Engineering", "attachment_aa_defense_reverse",
						"Defense Vs. Blind", "attachment_aa_blind_defense",
						"Defense Vs. Dizzy", "attachment_aa_dizzy_defense",
						"Defense Vs. Intimidate", "attachment_aa_intimidate_defense",
						"Defense Vs. Knockdown", "attachment_aa_knockdown_defense",
						"Defense Vs. Posture Change (Down)", "attachment_aa_posture_change_down_defense",
						"Defense Vs. Posture Change (Up)", "attachment_aa_posture_change_up_defense",
						"Defense Vs. Stun", "attachment_aa_stun_defense",
						"Defensive Acuity", "attachment_aa_unarmed_passive_defense",
						"Disease Absorption", "attachment_aa_absorption_disease",
						"Disease Dissipation", "attachment_aa_dissipation_disease",
						"Disease Resistance", "attachment_aa_resistance_disease",
						"Disguising", "attachment_aa_disguise_effectiveness",
						"DNA Harvesting", "attachment_aa_dna_harvesting",
						"Dodge", "attachment_aa_dodge",
						"Domestic Arts Assembly", "attachment_aa_domestic_assembly",
						"Dosh (Comprehension)", "attachment_aa_language_trandoshan_comprehend",
						"Dosh (Speech)", "attachment_aa_language_trandoshan_speak",
						"Dosh", "attachment_aa_language_trandoshan",
						"Double-Bladed Lightsaber Accuracy", "attachment_aa_polearmlightsaber_accuracy",
						"Double-Bladed Lightsaber Speed", "attachment_aa_polearmlightsaber_speed",
						"Double-Bladed Lightsaber Toughness", "attachment_aa_polearmlightsaber_toughness",
						"Droid Assembly", "attachment_aa_droid_assembly",
						"Droid Complexity", "attachment_aa_droid_complexity",
						"Droid Customization", "attachment_aa_droid_customization",
						"Droid Experimentation", "attachment_aa_droid_experimentation",
						"Droid Precision", "attachment_aa_droid_find_chance",
						"Droid Speed", "attachment_aa_droid_find_speed",
						"Droid Tracking Speed", "attachment_aa_droid_track_speed",
						"Engine Assembly", "attachment_aa_engine_assembly",
						"Engine Experimentation", "attachment_aa_engine_experimentation",
						"Engineering Assembly", "attachment_aa_engineering_assembly",
						"Enhanced Melee Accuracy", "attachment_aa_melee_accuracy",
						"Enhanced Melee Speed", "attachment_aa_melee_speed",
						"Enhanced Ranged Accuracy", "attachment_aa_ranged_accuracy",
						"Enhanced Ranged Speed", "attachment_aa_ranged_speed",
						"Equilibrium", "attachment_aa_innate_equilibrium",
						"Equilibrium", "attachment_aa_private_innate_equilibrium",
						"Face-form", "attachment_aa_face",
						"Factory Efficiency", "attachment_aa_factory_efficiency",
						"Factory Speed", "attachment_aa_factory_speed",
						"Farm Efficiency", "attachment_aa_farm_efficiency",
						"Farm Maintenance", "attachment_aa_farm_maintenance",
						"Farm Management", "attachment_aa_farm_management",
						"Farm Production Speed", "attachment_aa_farm_speed",
						"Feign Death", "attachment_aa_feign_death",
						"Fire Absorption", "attachment_aa_absorption_fire",
						"Fire Dissipation", "attachment_aa_dissipation_fire",
						"Fire Resistance", "attachment_aa_resistance_fire",
						"Firearm Assembly", "attachment_aa_firearm_assembly",
						"Firearm Complexity", "attachment_aa_firearm_complexity",
						"Firearm Experimentation", "attachment_aa_firearm_experimentation",
						"Flamethrower Accuracy", "attachment_aa_heavy_flame_thrower_accuracy",
						"Flamethrower Speed", "attachment_aa_heavy_flame_thrower_speed",
						"Flora Harvester Efficiency", "attachment_aa_flora_harvester_efficiency",
						"Flora Harvester Maintenance", "attachment_aa_flora_harvester_maintenance",
						"Flora Harvester Speed", "attachment_aa_flora_harvester_speed",
						"Flora Production", "attachment_aa_farm_produce_flora",
						"Flora Surveying Range", "attachment_aa_survey_flora_structural_range",
						"Flora Surveying Resolution", "attachment_aa_survey_flora_structural_resolution",
						"Flora Surveying", "attachment_aa_survey_flora_structural",
						"Food Assembly", "attachment_aa_food_assembly",
						"Food Complexity", "attachment_aa_food_complexity",
						"Food Experimentation", "attachment_aa_food_experimentation",
						"Foraging", "attachment_aa_foraging",
						"Force Absorb", "attachment_aa_force_absorb",
						"Force Armor", "attachment_aa_force_armor",
						"Force Assembly", "attachment_aa_force_assembly",
						"Force Choke", "attachment_aa_force_choke",
						"Force Control: Dark", "attachment_aa_force_control_dark",
						"Force Control: Light", "attachment_aa_force_control_light",
						"Force Defense", "attachment_aa_force_defense",
						"Force Experimentation", "attachment_aa_force_experimentation",
						"Force Feedback", "attachment_aa_force_feedback",
						"Force Intimidate Accuracy", "attachment_aa_forceintimidate_accuracy",
						"Force Knockdown Accuracy", "attachment_aa_forceknockdown_accuracy",
						"Force Lightning Accuracy", "attachment_aa_forcelightning_accuracy",
						"Force Lightning", "attachment_aa_lightning",
						"Force Manipulation: Dark", "attachment_aa_force_manipulation_dark",
						"Force Manipulation: Light", "attachment_aa_force_manipulation_light",
						"Force Power Max", "attachment_aa_jedi_force_power_max",
						"Force Power Regeneration", "attachment_aa_jedi_force_power_regen",
						"Force Power: Dark", "attachment_aa_force_power_dark",
						"Force Power: Light", "attachment_aa_force_power_light",
						"Force Psyche", "attachment_aa_mental",
						"Force Repair Bonus", "attachment_aa_force_repair_bonus",
						"Force Run", "attachment_aa_force_run",
						"Force Shield", "attachment_aa_force_shield",
						"Force Throw Accuracy", "attachment_aa_forcethrow_accuracy",
						"Force Vehicular Acceleration", "attachment_aa_force_vehicle_speed",
						"Force Vehicular Control", "attachment_aa_force_vehicle_control",
						"Force Weaken Accuracy", "attachment_aa_forceweaken_accuracy",
					},
					"G-L",
					{
						"Gas Surveying Range", "attachment_aa_survey_gas_range",
						"Gas Surveying Resolution", "attachment_aa_survey_gas_resolution",
						"Gas Surveying", "attachment_aa_survey_gas",
						"General Ranged Aiming", "attachment_aa_aim",
						"Grenade Assembly", "attachment_aa_grenade_assembly",
						"Grenade Experimentation", "attachment_aa_grenade_experimentation",
						"Group Burst Run Efficiency", "attachment_aa_group_burst_run",
						"Group Defense Bonus", "attachment_aa_group_defense",
						"Group Melee Defense", "attachment_aa_group_melee_defense",
						"Group Offense Bonus", "attachment_aa_group_offense",
						"Group Ranged Defense", "attachment_aa_group_ranged_defense",
						"Group Terrain Negotiation", "attachment_aa_group_slope_move",
						"Hair Styling", "attachment_aa_hair",
						"Harvester Efficiency", "attachment_aa_harvester_efficiency",
						"Harvester Maintenance", "attachment_aa_harvester_maintenance",
						"Harvester Speed", "attachment_aa_harvester_speed",
						"Healing Range", "attachment_aa_healing_range",
						"Healing with Dance", "attachment_aa_dance_heal_injury",
						"Healing with Music", "attachment_aa_music_heal_injury",
						"Heavy Acid Beam Accuracy", "attachment_aa_heavy_acid_beam_accuracy",
						"Heavy Acid Beam Speed", "attachment_aa_heavy_acid_beam_speed",
						"Heavy Acid Rifle Accuracy", "attachment_aa_heavy_acid_rifle_accuracy",
						"Heavy Acid Rifle Accuracy", "attachment_aa_heavy_rifle_acid_accuracy",
						"Heavy Acid Rifle Speed", "attachment_aa_heavy_acid_rifle_speed",
						"Heavy Acid Rifle Speed", "attachment_aa_heavy_rifle_acid_speed",
						"Heavy Lightning Beam Accuracy", "attachment_aa_heavy_lightning_beam_accuracy",
						"Heavy Lightning Beam Speed", "attachment_aa_heavy_lightning_beam_speed",
						"Heavy Particle Beam Accuracy", "attachment_aa_heavy_particle_beam_accuracy",
						"Heavy Particle Beam Speed", "attachment_aa_heavy_particle_beam_speed",
						"Heavy Rocket Launcher Accuracy", "attachment_aa_heavy_rocket_launcher_accuracy",
						"Heavy Rocket Launcher Speed", "attachment_aa_heavy_rocket_launcher_speed",
						"Heavy Weapon Accuracy", "attachment_aa_heavyweapon_accuracy",
						"Heavy Weapon Speed", "attachment_aa_heavyweapon_speed",
						"Hiring", "attachment_aa_hiring",
						"Injury Treatment Speed", "attachment_aa_healing_injury_speed",
						"Injury Treatment", "attachment_aa_healing_injury_treatment",
						"Instrument Assembly", "attachment_aa_instrument_assembly",
						"Intimidation", "attachment_aa_intimidate",
						"Ithorian (Comprehension)", "attachment_aa_language_ithorian_comprehend",
						"Ithorian (Speech)", "attachment_aa_language_ithorian_speak",
						"Ithorian", "attachment_aa_language_ithorian",
						"Jedi State Defense", "attachment_aa_jedi_state_defense",
						"Jedi Toughness", "attachment_aa_jedi_toughness",
						"Language Comprehension", "attachment_aa_language_all_comprehend",
						"Leadership", "attachment_aa_leadership",
						"Lekku (Comprehension)", "attachment_aa_language_lekku_comprehend",
						"Lekku (Silent Speech)", "attachment_aa_language_lekku_speak",
						"Lekku", "attachment_aa_language_lekku",
						"Light Force: Serenity", "attachment_aa_frs_light_serenity",
						"Light Force: Vigilance", "attachment_aa_frs_light_vigilance",
						"Light Force: Wisdom", "attachment_aa_frs_light_wisdom",
						"Light Lightning Cannon Accuracy", "attachment_aa_heavy_lighting_rifle_accuracy",
						"Light Lightning Cannon Accuracy", "attachment_aa_heavy_lightning_rifle_accuracy",
						"Light Lightning Cannon Accuracy", "attachment_aa_heavy_rifle_lighting_accuracy",
						"Light Lightning Cannon Accuracy", "attachment_aa_heavy_rifle_lightning_accuracy",
						"Light Lightning Cannon Accuracy", "attachment_aa_light_lightning_cannon_accuracy",
						"Light Lightning Cannon Speed", "attachment_aa_heavy_rifle_lightning_speed",
						"Lightsaber Assembly", "attachment_aa_jedi_saber_assembly",
						"Lightsaber Block", "attachment_aa_saber_block",
						"Lightsaber Experimentation", "attachment_aa_jedi_saber_experimentation",
						"Lightsaber Toughness", "attachment_aa_lightsaber_toughness",
						"Liquid Surveying Range", "attachment_aa_survey_liquid_range",
						"Liquid Surveying Resolution", "attachment_aa_survey_liquid_resolution",
						"Liquid Surveying", "attachment_aa_survey_liquid",
						"Livestock Production", "attachment_aa_farm_produce_livestock",
						"Luck", "attachment_aa_force_luck",
					},
						"M-P",
						{
						"Marking Design", "attachment_aa_markings",
						"Mask Scent", "attachment_aa_mask_scent",
						"Max level of pets", "attachment_aa_tame_level",
						"Medical Foraging", "attachment_aa_medical_foraging",
						"Medicine Assembly", "attachment_aa_medicine_assembly",
						"Medicine Experimentation", "attachment_aa_medicine_experimentation",
						"Medicine Use", "attachment_aa_healing_ability",
						"Meditate", "attachment_aa_meditate",
						"Melee Defense", "attachment_aa_melee_defense",
						"Melee Experimentation", "attachment_aa_melee_experimentation",
						"Melee Weapon Assembly", "attachment_aa_melee_assembly",
						"Melee Weapon Complexity", "attachment_aa_melee_complexity",
						"Mind Blast Accuracy", "attachment_aa_mindblast_accuracy",
						"Mineral Surveying Range", "attachment_aa_survey_solid_range",
						"Mineral Surveying Resolution", "attachment_aa_survey_solid_resolution",
						"Mineral Surveying", "attachment_aa_survey_solid",
						"Missile Launching Skill", "attachment_aa_missile_launching",
						"Mon Calamarian (Comprehension)", "attachment_aa_language_moncalamari_comprehend",
						"Mon Calamarian (Speech)", "attachment_aa_language_moncalamari_speak",
						"Mon Calamarian", "attachment_aa_language_moncalamari",
						"Morale Management", "attachment_aa_morale_management",
						"Mounted Creature", "attachment_aa_mountedcreature",
						"Munition Assembly", "attachment_aa_munition_assembly",
						"Munition Complexity", "attachment_aa_munition_complexity",
						"Munition Experimentation", "attachment_aa_munition_experimentation",
						"Music Knowledge", "attachment_aa_healing_music_ability",
						"Musical Mind Enhancement", "attachment_aa_healing_music_mind",
						"Offensive Strategy", "attachment_aa_offensive_strategy",
						"One Handed Pole Arm", "attachment_aa_onehandpolearm",
						"One Handed Technique", "attachment_aa_onehandtechnique",
						"One-handed Center Of Being Duration", "attachment_aa_center_of_being_duration_onehandmelee",
						"One-handed Lightsaber Accuracy", "attachment_aa_onehandlightsaber_accuracy",
						"One-handed Lightsaber Speed", "attachment_aa_onehandlightsaber_speed",
						"One-handed Lightsaber Toughness", "attachment_aa_onehandlightsaber_toughness",
						"One-handed Melee Center Of Being Efficacy", "attachment_aa_onehandmelee_center_of_being_efficacy",
						"One-handed Melee Damage", "attachment_aa_onehandmelee_damage",
						"One-handed Melee Toughness", "attachment_aa_onehandmelee_toughness",
						"One-handed Weapon Accuracy", "attachment_aa_onehandmelee_accuracy",
						"One-handed Weapon Accuracy", "attachment_aa_onehandmeleeaccuracy",
						"One-handed Weapon Counter Attack", "attachment_aa_onehandmelee_counter_attack",
						"One-handed Weapon Evasion", "attachment_aa_onehandmelee_evasion",
						"One-handed Weapon Speed", "attachment_aa_onehandmelee_speed",
						"Persuasion", "attachment_aa_force_persuade",
						"Pilot Special Tactics", "attachment_aa_pilot_special_tactics",
						"Pistol Accuracy While Kneeling", "attachment_aa_pistol_kneeling",
						"Pistol Accuracy While Moving", "attachment_aa_pistol_hit_while_moving",
						"Pistol Accuracy While Prone", "attachment_aa_pistol_prone",
						"Pistol Accuracy While Standing", "attachment_aa_pistol_accuracy_while_standing",
						"Pistol Accuracy While Standing", "attachment_aa_pistol_standing",
						"Pistol Accuracy", "attachment_aa_pistol_accuracy",
						"Pistol Aiming", "attachment_aa_pistol_aim",
						"Pistol Counter Attack", "attachment_aa_pistol_counterattack",
						"Pistol Damage", "attachment_aa_pistol_damage",
						"Pistol Speed", "attachment_aa_pistol_speed",
						"Poison Absorption", "attachment_aa_absorption_poison",
						"Poison Dissipation", "attachment_aa_dissipation_poison",
						"Poison Resistance", "attachment_aa_resistance_poison",
						"Polearm Accuracy", "attachment_aa_polearm_accuracy",
						"Polearm Center Of Being Duration", "attachment_aa_center_of_being_duration_polearm",
						"Polearm Center Of Being Efficacy", "attachment_aa_polearm_center_of_being_efficacy",
						"Polearm Counter Attack", "attachment_aa_polearm_counter_attack",
						"Polearm Evasion", "attachment_aa_polearm_evasion",
						"Polearm Speed", "attachment_aa_polearm_speed",
						"Polearm Toughness", "attachment_aa_polearm_toughness",
						"Power Systems Experimentation", "attachment_aa_power_systems_experimentation",
						"Power Systems", "attachment_aa_power_systems",
						"Propulsion Reverse Engineering", "attachment_aa_propulsion_reverse",
						"Pursuasion", "attachment_aa_persuade_lie",
					},
					"R-T",
					{
						"Rally Shot Bonus", "attachment_aa_rally",
						"Ranged Defense", "attachment_aa_ranged_defense",
						"Ranged Healing Accuracy", "attachment_aa_healer_accuracy",
						"Ranged Healing Speed", "attachment_aa_healer_speed",
						"Ranged Injury Treatment Speed", "attachment_aa_healing_range_speed",
						"Regeneration", "attachment_aa_innate_regeneration",
						"Regeneration", "attachment_aa_private_innage_regeneration",
						"Regeneration", "attachment_aa_private_innate_regeneration",
						"Repair", "attachment_aa_crafting_repair",
						"Repel Creatures", "attachment_aa_camp_repel_creature",
						"Rescue", "attachment_aa_rescue",
						"Resist Creature Attacks", "attachment_aa_resist_creature_attack",
						"Resist Creature Attacks", "attachment_aa_resistcreatureattack",
						"Reverse Engineering", "attachment_aa_reverse_engineering",
						"Riding Mount", "attachment_aa_ridingmount",
						"Rifle Accuracy While Kneeling", "attachment_aa_rifle_kneeling",
						"Rifle Accuracy While Moving", "attachment_aa_rifle_hit_while_moving",
						"Rifle Accuracy While Prone", "attachment_aa_rifle_prone",
						"Rifle Accuracy While Standing", "attachment_aa_rifle_standing",
						"Rifle Accuracy", "attachment_aa_rifle_accuracy",
						"Rifle Aiming", "attachment_aa_rifle_aim",
						"Rifle Concealment Chance", "attachment_aa_rifle_concealment_chance",
						"Rifle Counterattacks", "attachment_aa_rifle_counterattack",
						"Rifle Crawl Speed", "attachment_aa_rifle_crawl",
						"Rifle Damage", "attachment_aa_rifle_damage",
						"Rifle Speed", "attachment_aa_rifle_speed",
						"Rodese (Comprehension)", "attachment_aa_language_rodian_comprehend",
						"Rodese (Speech)", "attachment_aa_language_rodian_speak",
						"Rodese", "attachment_aa_language_rodian",
						"Ryl (Comprehension)", "attachment_aa_language_twilek_comprehend",
						"Ryl (Speech)", "attachment_aa_language_twilek_speak",
						"Ryl", "attachment_aa_language_twilek",
						"Sales", "attachment_aa_sales",
						"Shield Experimentation", "attachment_aa_shields_experimentation",
						"Shields Assembly", "attachment_aa_shields_assembly",
						"Shop Sign Options", "attachment_aa_shop_sign",
						"Shyriiwook (Comprehension)", "attachment_aa_language_wookiee_comprehend",
						"Shyriiwook (Speech)", "attachment_aa_language_wookiee_speak",
						"Shyriiwook", "attachment_aa_language_wookiee",
						"Slicing", "attachment_aa_slice_market",
						"Spice Assembly", "attachment_aa_spice_assembly",
						"Spice Experimentation", "attachment_aa_spice_experimentation",
						"States Resistance", "attachment_aa_resistance_states",
						"Steady Aim Bonus", "attachment_aa_steadyaim",
						"Stored Pets", "attachment_aa_stored_pets",
						"Structure Assembly", "attachment_aa_structure_assembly",
						"Structure Complexity", "attachment_aa_structure_complexity",
						"Structure Experimentation", "attachment_aa_structure_experimentation",
						"Structure Maintenance", "attachment_aa_structure_maintenance_mod",
						"Sullustan (Comprehension)", "attachment_aa_language_sullustan_comprehend",
						"Sullustan (Speech)", "attachment_aa_language_sullustan_speak",
						"Sullustan", "attachment_aa_language_sullustan",
						"Surveying", "attachment_aa_surveying",
						"Systems Reverse Engineering", "attachment_aa_systems_reverse",
						"Taking Cover", "attachment_aa_cover",
						"Taming Vicious Creatures", "attachment_aa_tame_aggro",
						"Taming Wild Creatures", "attachment_aa_tame_non_aggro",
						"Taunt", "attachment_aa_taunt",
						"Terrain Negotiation", "attachment_aa_slope_move",
						"Thrown Weapon Accuracy", "attachment_aa_thrown_accuracy",
						"Thrown Weapon Speed", "attachment_aa_thrown_speed",
						"Tissue Assembly", "attachment_aa_tissue_assembly",
						"Tissue Experimentation", "attachment_aa_tissue_experimentation",
						"Tracking Droid Effectiveness", "attachment_aa_droid_track_chance",
						"Tracking Droids", "attachment_aa_droid_tracks",
						"Trapping", "attachment_aa_trapping",
						"Two Handed Pole Arm", "attachment_aa_twohandpolearm",
						"Two Handed Technique", "attachment_aa_twohandtechnique",
						"Two-handed Lightsaber Accuracy", "attachment_aa_twohandlightsaber_accuracy",
						"Two-handed Lightsaber Speed", "attachment_aa_twohandlightsaber_speed",
						"Two-handed Lightsaber Toughness", "attachment_aa_twohandlightsaber_toughness",
						"Two-handed Melee Accuracy", "attachment_aa_twohandmelee_accuracy",
						"Two-handed Melee Center Of Being Efficacy", "attachment_aa_twohandmelee_center_of_being_efficacy",
						"Two-handed melee Center of Being", "attachment_aa_center_of_being_duration_twohandmelee",
						"Two-handed Melee Counter Attacks", "attachment_aa_twohandmelee_counter_attack",
						"Two-handed Melee Damage", "attachment_aa_twohandedmeleedamage",
						"Two-handed Melee Damage", "attachment_aa_twohandmelee_damage",
						"Two-handed Melee Evasion", "attachment_aa_twohandmelee_evasion",
						"Two-handed Melee Speed", "attachment_aa_twohandmelee_speed",
						"Two-handed Melee Toughness", "attachment_aa_twohandmelee_toughness",
						"Two-handed Weapon Accuracy", "attachment_aa_twohandedmelee_accuracy",
						"Two-handed Weapon Counter Attack", "attachment_aa_twohandedmelee_counter_attack",
						"Two-handed Weapon Evasion", "attachment_aa_twohandedmelee_evasion",
						"Two-handed Weapon Speed", "attachment_aa_twohandedmelee_speed",
					},
					"U-Z",
					{
						"Unarmed Accuracy", "attachment_aa_unarmed_accuracy",
						"Unarmed Center Of Being Duration", "attachment_aa_center_of_being_duration_unarmed",
						"Unarmed Center Of Being Efficacy", "attachment_aa_unarmed_center_of_being_efficacy",
						"Unarmed Damage", "attachment_aa_unarmed_damage",
						"Unarmed Speed", "attachment_aa_unarmed_speed",
						"Unarmed Toughness", "attachment_aa_unarmed_toughness",
						"Vendor Item Limit", "attachment_aa_vendor_item_limit",
						"Vendors", "attachment_aa_manage_vendor",
						"Vitalize", "attachment_aa_innate_vitalize",
						"Vitalize", "attachment_aa_private_innate_vitalize",
						"Volley Fire Bonus", "attachment_aa_volley",
						"Warcry", "attachment_aa_warcry",
						"Weapon Assembly", "attachment_aa_weapon_assembly",
						"Weapon Experimentation", "attachment_aa_weapon_experimentation",
						"Weapon Repair", "attachment_aa_weapon_repair",
						"Weapon Systems Experimentation", "attachment_aa_weapon_systems_experimentation",
						"Weapon Systems", "attachment_aa_weapon_systems",
						"Wookiee Roar", "attachment_aa_innate_roar",
						"Wookiee Roar", "attachment_aa_private_innate_roar",
						"Wound Healing (Dancing)", "attachment_aa_healing_dance_wound",
						"Wound Healing (Music)", "attachment_aa_healing_music_wound",
						"Wound Healing", "attachment_aa_general_wound",
						"Wound Treatment Speed", "attachment_aa_healing_wound_speed",
						"Wound Treatment", "attachment_aa_healing_wound_treatment",
						"Zabrak (Comprehension)", "attachment_aa_language_zabrak_comprehend",
						"Zabrak (Speech)", "attachment_aa_language_zabrak_speak",
						"Zabrak", "attachment_aa_language_zabrak"
					}
				},
				"Clothing",
					{
						"A-C",
						{
							"Additional Pets", "attachment_ca_keep_creature",
							"Advanced Assembly", "attachment_ca_advanced_assembly",
							"Advanced Camping", "attachment_ca_camp_advanced",
							"Advanced Component Experimentation", "attachment_ca_advanced_ship_experimentation",
							"Advertising", "attachment_ca_advertising",
							"Alertness", "attachment_ca_alert",
							"Anti-Blind", "attachment_ca_anti_blind",
							"Anti-Dizzy", "attachment_ca_anti_dizzy",
							"Anti-Intimidate", "attachment_ca_anti_intimidate",
							"Anti-Shock", "attachment_ca_anti_shock",
							"Anti-Stun", "attachment_ca_anti_stun",
							"Armor Assembly", "attachment_ca_armor_assembly",
							"Armor Complexity", "attachment_ca_armor_complexity",
							"Armor Customization", "attachment_ca_armor_customization",
							"Armor Experimentation", "attachment_ca_armor_experimentation",
							"Armor Repair", "attachment_ca_armor_repair",
							"Artisan Assembly", "attachment_ca_general_assembly",
							"Artisan Clothing Customization", "attachment_ca_artisan_clothing_customization",
							"Artisan Experimentation", "attachment_ca_general_experimentation",
							"Basic (Comprehension)", "attachment_ca_language_basic_comprehend",
							"Basic (Speech)", "attachment_ca_language_basic_speak",
							"Battle Fatigue Healing (Dancing)", "attachment_ca_healing_dance_shock",
							"Battle Fatigue Healing (Music)", "attachment_ca_healing_music_shock",
							"Berserk", "attachment_ca_berserk",
							"Bio-Engineer Assembly", "attachment_ca_bio_engineer_assembly",
							"Bio-Engineer Experimentation", "attachment_ca_bio_engineer_experimentation",
							"Bleeding Absorption", "attachment_ca_absorption_bleeding",
							"Bleeding Dissipation", "attachment_ca_dissipation_bleeding",
							"Bleeding Resistance", "attachment_ca_resistance_bleeding",
							"Block", "attachment_ca_block",
							"Bodyform", "attachment_ca_body",
							"Booster Assembly", "attachment_ca_booster_assembly",
							"Booster Experimentation", "attachment_ca_booster_experimentation",
							"Bothese (Comprehension)", "attachment_ca_language_bothan_comprehend",
							"Bothese (Speech)", "attachment_ca_language_bothan_speak",
							"Bothese", "attachment_ca_language_bothan",
							"Bounty Mission Difficulty", "attachment_ca_bounty_mission_level",
							"Bribery", "attachment_ca_persuade_bribe",
							"Burst Run Efficiency", "attachment_ca_burst_run",
							"Business Acumen", "attachment_ca_business_acumen",
							"Camouflage", "attachment_ca_camouflage",
							"Camping - Repel Creatures", "attachment_ca_camprepelcreature",
							"Camping", "attachment_ca_camp",
							"Carbine Accuracy While Kneeling", "attachment_ca_carbine_kneeling",
							"Carbine Accuracy While Moving", "attachment_ca_carbine_hit_while_moving",
							"Carbine Accuracy While Prone", "attachment_ca_carbine_prone",
							"Carbine Accuracy While Standing", "attachment_ca_carbine_standing",
							"Carbine Accuracy", "attachment_ca_carbine_acccuracy",
							"Carbine Accuracy", "attachment_ca_carbine_accuracy",
							"Carbine Aiming", "attachment_ca_carbine_aim",
							"Carbine Counterattacks", "attachment_ca_carbine_counterattack",
							"Carbine Damage", "attachment_ca_carbine_damage",
							"Carbine Speed", "attachment_ca_carbine_speed",
							"Chassis Assembly", "attachment_ca_chassis_assembly",
							"Chassis Experimentation", "attachment_ca_chassis_experimentation",
							"Chassis/Armor Reverse Engineering", "attachment_ca_engineering_reverse",
							"Clothing Assembly", "attachment_ca_clothing_assembly",
							"Clothing Complexity", "attachment_ca_clothing_complexity",
							"Clothing Customization", "attachment_ca_clothing_customization",
							"Clothing Experimentation", "attachment_ca_clothing_experimentation",
							"Clothing Repair", "attachment_ca_clothing_repair",
							"Combat Bleeding Defense", "attachment_ca_combat_bleeding_defense",
							"Combat Equilibrium", "attachment_ca_combat_equilibrium",
							"Combat Equilibrium", "attachment_ca_combat_equillibrium",
							"Combat Haste", "attachment_ca_combat_haste",
							"Combat Medic Effectiveness", "attachment_ca_combat_medic_effectiveness",
							"Combat Medicine Assembly", "attachment_ca_combat_medicine_assembly",
							"Combat Medicine Experimentation", "attachment_ca_combat_medicine_experimentation",
							"Combat Medicine Use", "attachment_ca_combat_healing_ability",
							"Contraband Concealment", "attachment_ca_conceal_contraband",
							"Counterattack", "attachment_ca_counterattack",
							"Cover", "attachment_ca_take_cover",
							"Cover", "attachment_ca_takecover",
							"Crafting Medicine Complexity", "attachment_ca_medicine_complexity",
							"Crafting Technique", "attachment_ca_force_failure_reduction",
							"Creature Assembly", "attachment_ca_creature_assembly",
							"Creature Empathy", "attachment_ca_creature_empathy",
							"Creature Experimentation", "attachment_ca_creature_experimentation",
							"Creature Harvesting", "attachment_ca_creature_harvesting",
							"Creature Knowledge", "attachment_ca_creature_knowledge",
							"Creature Knowledge", "attachment_ca_creatureknowledge",
							"Creature Management", "attachment_ca_creature_management",
							"Creature Taming Bonus", "attachment_ca_tame_bonus",
							"Creature To-Hit Bonus", "attachment_ca_creature_hit_bonus",
							"Creature Tracking", "attachment_ca_track_creature",
							"Creature Tracking", "attachment_ca_trackcreature",
							"Creature Training", "attachment_ca_creature_training",
							"Creature Wound Healing", "attachment_ca_heal_creature_wound"
						},
						"D-F",
						{
						"Damage Healing", "attachment_ca_general_damage",
						"Dance Knowledge", "attachment_ca_healing_dance_ability",
						"Dancing Mind Enhancement", "attachment_ca_healing_dance_mind",
						"Dark Force: Envy", "attachment_ca_frs_dark_envy",
						"Dark Force: Suffering", "attachment_ca_frs_dark_suffering",
						"Dark Force: Vengeance", "attachment_ca_frs_dark_vengeance",
						"Defense Reverse Engineering", "attachment_ca_defense_reverse",
						"Defense Vs. Blind", "attachment_ca_blind_defense",
						"Defense Vs. Dizzy", "attachment_ca_dizzy_defense",
						"Defense Vs. Intimidate", "attachment_ca_intimidate_defense",
						"Defense Vs. Knockdown", "attachment_ca_knockdown_defense",
						"Defense Vs. Posture Change (Down)", "attachment_ca_posture_change_down_defense",
						"Defense Vs. Posture Change (Up)", "attachment_ca_posture_change_up_defense",
						"Defense Vs. Stun", "attachment_ca_stun_defense",
						"Defensive Acuity", "attachment_ca_unarmed_passive_defense",
						"Disease Absorption", "attachment_ca_absorption_disease",
						"Disease Dissipation", "attachment_ca_dissipation_disease",
						"Disease Resistance", "attachment_ca_resistance_disease",
						"Disguising", "attachment_ca_disguise_effectiveness",
						"DNA Harvesting", "attachment_ca_dna_harvesting",
						"Dodge", "attachment_ca_dodge",
						"Domestic Arts Assembly", "attachment_ca_domestic_assembly",
						"Dosh (Comprehension)", "attachment_ca_language_trandoshan_comprehend",
						"Dosh (Speech)", "attachment_ca_language_trandoshan_speak",
						"Dosh", "attachment_ca_language_trandoshan",
						"Double-Bladed Lightsaber Accuracy", "attachment_ca_polearmlightsaber_accuracy",
						"Double-Bladed Lightsaber Speed", "attachment_ca_polearmlightsaber_speed",
						"Double-Bladed Lightsaber Toughness", "attachment_ca_polearmlightsaber_toughness",
						"Droid Assembly", "attachment_ca_droid_assembly",
						"Droid Complexity", "attachment_ca_droid_complexity",
						"Droid Customization", "attachment_ca_droid_customization",
						"Droid Experimentation", "attachment_ca_droid_experimentation",
						"Droid Precision", "attachment_ca_droid_find_chance",
						"Droid Speed", "attachment_ca_droid_find_speed",
						"Droid Tracking Speed", "attachment_ca_droid_track_speed",
						"Engine Assembly", "attachment_ca_engine_assembly",
						"Engine Experimentation", "attachment_ca_engine_experimentation",
						"Engineering Assembly", "attachment_ca_engineering_assembly",
						"Enhanced Melee Accuracy", "attachment_ca_melee_accuracy",
						"Enhanced Melee Speed", "attachment_ca_melee_speed",
						"Enhanced Ranged Accuracy", "attachment_ca_ranged_accuracy",
						"Enhanced Ranged Speed", "attachment_ca_ranged_speed",
						"Equilibrium", "attachment_ca_innate_equilibrium",
						"Equilibrium", "attachment_ca_private_innate_equilibrium",
						"Face-form", "attachment_ca_face",
						"Factory Efficiency", "attachment_ca_factory_efficiency",
						"Factory Speed", "attachment_ca_factory_speed",
						"Farm Efficiency", "attachment_ca_farm_efficiency",
						"Farm Maintenance", "attachment_ca_farm_maintenance",
						"Farm Management", "attachment_ca_farm_management",
						"Farm Production Speed", "attachment_ca_farm_speed",
						"Feign Death", "attachment_ca_feign_death",
						"Fire Absorption", "attachment_ca_absorption_fire",
						"Fire Dissipation", "attachment_ca_dissipation_fire",
						"Fire Resistance", "attachment_ca_resistance_fire",
						"Firearm Assembly", "attachment_ca_firearm_assembly",
						"Firearm Complexity", "attachment_ca_firearm_complexity",
						"Firearm Experimentation", "attachment_ca_firearm_experimentation",
						"Flamethrower Accuracy", "attachment_ca_heavy_flame_thrower_accuracy",
						"Flamethrower Speed", "attachment_ca_heavy_flame_thrower_speed",
						"Flora Harvester Efficiency", "attachment_ca_flora_harvester_efficiency",
						"Flora Harvester Maintenance", "attachment_ca_flora_harvester_maintenance",
						"Flora Harvester Speed", "attachment_ca_flora_harvester_speed",
						"Flora Production", "attachment_ca_farm_produce_flora",
						"Flora Surveying Range", "attachment_ca_survey_flora_structural_range",
						"Flora Surveying Resolution", "attachment_ca_survey_flora_structural_resolution",
						"Flora Surveying", "attachment_ca_survey_flora_structural",
						"Food Assembly", "attachment_ca_food_assembly",
						"Food Complexity", "attachment_ca_food_complexity",
						"Food Experimentation", "attachment_ca_food_experimentation",
						"Foraging", "attachment_ca_foraging",
						"Force Absorb", "attachment_ca_force_absorb",
						"Force Armor", "attachment_ca_force_armor",
						"Force Assembly", "attachment_ca_force_assembly",
						"Force Choke", "attachment_ca_force_choke",
						"Force Control: Dark", "attachment_ca_force_control_dark",
						"Force Control: Light", "attachment_ca_force_control_light",
						"Force Defense", "attachment_ca_force_defense",
						"Force Experimentation", "attachment_ca_force_experimentation",
						"Force Feedback", "attachment_ca_force_feedback",
						"Force Intimidate Accuracy", "attachment_ca_forceintimidate_accuracy",
						"Force Knockdown Accuracy", "attachment_ca_forceknockdown_accuracy",
						"Force Lightning Accuracy", "attachment_ca_forcelightning_accuracy",
						"Force Lightning", "attachment_ca_lightning",
						"Force Manipulation: Dark", "attachment_ca_force_manipulation_dark",
						"Force Manipulation: Light", "attachment_ca_force_manipulation_light",
						"Force Power Max", "attachment_ca_jedi_force_power_max",
						"Force Power Regeneration", "attachment_ca_jedi_force_power_regen",
						"Force Power: Dark", "attachment_ca_force_power_dark",
						"Force Power: Light", "attachment_ca_force_power_light",
						"Force Psyche", "attachment_ca_mental",
						"Force Repair Bonus", "attachment_ca_force_repair_bonus",
						"Force Run", "attachment_ca_force_run",
						"Force Shield", "attachment_ca_force_shield",
						"Force Throw Accuracy", "attachment_ca_forcethrow_accuracy",
						"Force Vehicular Acceleration", "attachment_ca_force_vehicle_speed",
						"Force Vehicular Control", "attachment_ca_force_vehicle_control",
						"Force Weaken Accuracy", "attachment_ca_forceweaken_accuracy",
					},
					"G-L",
					{
						"Gas Surveying Range", "attachment_ca_survey_gas_range",
						"Gas Surveying Resolution", "attachment_ca_survey_gas_resolution",
						"Gas Surveying", "attachment_ca_survey_gas",
						"General Ranged Aiming", "attachment_ca_aim",
						"Grenade Assembly", "attachment_ca_grenade_assembly",
						"Grenade Experimentation", "attachment_ca_grenade_experimentation",
						"Group Burst Run Efficiency", "attachment_ca_group_burst_run",
						"Group Defense Bonus", "attachment_ca_group_defense",
						"Group Melee Defense", "attachment_ca_group_melee_defense",
						"Group Offense Bonus", "attachment_ca_group_offense",
						"Group Ranged Defense", "attachment_ca_group_ranged_defense",
						"Group Terrain Negotiation", "attachment_ca_group_slope_move",
						"Hair Styling", "attachment_ca_hair",
						"Harvester Efficiency", "attachment_ca_harvester_efficiency",
						"Harvester Maintenance", "attachment_ca_harvester_maintenance",
						"Harvester Speed", "attachment_ca_harvester_speed",
						"Healing Range", "attachment_ca_healing_range",
						"Healing with Dance", "attachment_ca_dance_heal_injury",
						"Healing with Music", "attachment_ca_music_heal_injury",
						"Heavy Acid Beam Accuracy", "attachment_ca_heavy_acid_beam_accuracy",
						"Heavy Acid Beam Speed", "attachment_ca_heavy_acid_beam_speed",
						"Heavy Acid Rifle Accuracy", "attachment_ca_heavy_acid_rifle_accuracy",
						"Heavy Acid Rifle Accuracy", "attachment_ca_heavy_rifle_acid_accuracy",
						"Heavy Acid Rifle Speed", "attachment_ca_heavy_acid_rifle_speed",
						"Heavy Acid Rifle Speed", "attachment_ca_heavy_rifle_acid_speed",
						"Heavy Lightning Beam Accuracy", "attachment_ca_heavy_lightning_beam_accuracy",
						"Heavy Lightning Beam Speed", "attachment_ca_heavy_lightning_beam_speed",
						"Heavy Particle Beam Accuracy", "attachment_ca_heavy_particle_beam_accuracy",
						"Heavy Particle Beam Speed", "attachment_ca_heavy_particle_beam_speed",
						"Heavy Rocket Launcher Accuracy", "attachment_ca_heavy_rocket_launcher_accuracy",
						"Heavy Rocket Launcher Speed", "attachment_ca_heavy_rocket_launcher_speed",
						"Heavy Weapon Accuracy", "attachment_ca_heavyweapon_accuracy",
						"Heavy Weapon Speed", "attachment_ca_heavyweapon_speed",
						"Hiring", "attachment_ca_hiring",
						"Injury Treatment Speed", "attachment_ca_healing_injury_speed",
						"Injury Treatment", "attachment_ca_healing_injury_treatment",
						"Instrument Assembly", "attachment_ca_instrument_assembly",
						"Intimidation", "attachment_ca_intimidate",
						"Ithorian (Comprehension)", "attachment_ca_language_ithorian_comprehend",
						"Ithorian (Speech)", "attachment_ca_language_ithorian_speak",
						"Ithorian", "attachment_ca_language_ithorian",
						"Jedi State Defense", "attachment_ca_jedi_state_defense",
						"Jedi Toughness", "attachment_ca_jedi_toughness",
						"Language Comprehension", "attachment_ca_language_all_comprehend",
						"Leadership", "attachment_ca_leadership",
						"Lekku (Comprehension)", "attachment_ca_language_lekku_comprehend",
						"Lekku (Silent Speech)", "attachment_ca_language_lekku_speak",
						"Lekku", "attachment_ca_language_lekku",
						"Light Force: Serenity", "attachment_ca_frs_light_serenity",
						"Light Force: Vigilance", "attachment_ca_frs_light_vigilance",
						"Light Force: Wisdom", "attachment_ca_frs_light_wisdom",
						"Light Lightning Cannon Accuracy", "attachment_ca_heavy_lighting_rifle_accuracy",
						"Light Lightning Cannon Accuracy", "attachment_ca_heavy_lightning_rifle_accuracy",
						"Light Lightning Cannon Accuracy", "attachment_ca_heavy_rifle_lighting_accuracy",
						"Light Lightning Cannon Accuracy", "attachment_ca_heavy_rifle_lightning_accuracy",
						"Light Lightning Cannon Accuracy", "attachment_ca_light_lightning_cannon_accuracy",
						"Light Lightning Cannon Speed", "attachment_ca_heavy_rifle_lightning_speed",
						"Lightsaber Assembly", "attachment_ca_jedi_saber_assembly",
						"Lightsaber Block", "attachment_ca_saber_block",
						"Lightsaber Experimentation", "attachment_ca_jedi_saber_experimentation",
						"Lightsaber Toughness", "attachment_ca_lightsaber_toughness",
						"Liquid Surveying Range", "attachment_ca_survey_liquid_range",
						"Liquid Surveying Resolution", "attachment_ca_survey_liquid_resolution",
						"Liquid Surveying", "attachment_ca_survey_liquid",
						"Livestock Production", "attachment_ca_farm_produce_livestock",
						"Luck", "attachment_ca_force_luck",
					},
						"M-P",
						{
						"Marking Design", "attachment_ca_markings",
						"Mask Scent", "attachment_ca_mask_scent",
						"Max level of pets", "attachment_ca_tame_level",
						"Medical Foraging", "attachment_ca_medical_foraging",
						"Medicine Assembly", "attachment_ca_medicine_assembly",
						"Medicine Experimentation", "attachment_ca_medicine_experimentation",
						"Medicine Use", "attachment_ca_healing_ability",
						"Meditate", "attachment_ca_meditate",
						"Melee Defense", "attachment_ca_melee_defense",
						"Melee Experimentation", "attachment_ca_melee_experimentation",
						"Melee Weapon Assembly", "attachment_ca_melee_assembly",
						"Melee Weapon Complexity", "attachment_ca_melee_complexity",
						"Mind Blast Accuracy", "attachment_ca_mindblast_accuracy",
						"Mineral Surveying Range", "attachment_ca_survey_solid_range",
						"Mineral Surveying Resolution", "attachment_ca_survey_solid_resolution",
						"Mineral Surveying", "attachment_ca_survey_solid",
						"Missile Launching Skill", "attachment_ca_missile_launching",
						"Mon Calamarian (Comprehension)", "attachment_ca_language_moncalamari_comprehend",
						"Mon Calamarian (Speech)", "attachment_ca_language_moncalamari_speak",
						"Mon Calamarian", "attachment_ca_language_moncalamari",
						"Morale Management", "attachment_ca_morale_management",
						"Mounted Creature", "attachment_ca_mountedcreature",
						"Munition Assembly", "attachment_ca_munition_assembly",
						"Munition Complexity", "attachment_ca_munition_complexity",
						"Munition Experimentation", "attachment_ca_munition_experimentation",
						"Music Knowledge", "attachment_ca_healing_music_ability",
						"Musical Mind Enhancement", "attachment_ca_healing_music_mind",
						"Offensive Strategy", "attachment_ca_offensive_strategy",
						"One Handed Pole Arm", "attachment_ca_onehandpolearm",
						"One Handed Technique", "attachment_ca_onehandtechnique",
						"One-handed Center Of Being Duration", "attachment_ca_center_of_being_duration_onehandmelee",
						"One-handed Lightsaber Accuracy", "attachment_ca_onehandlightsaber_accuracy",
						"One-handed Lightsaber Speed", "attachment_ca_onehandlightsaber_speed",
						"One-handed Lightsaber Toughness", "attachment_ca_onehandlightsaber_toughness",
						"One-handed Melee Center Of Being Efficacy", "attachment_ca_onehandmelee_center_of_being_efficacy",
						"One-handed Melee Damage", "attachment_ca_onehandmelee_damage",
						"One-handed Melee Toughness", "attachment_ca_onehandmelee_toughness",
						"One-handed Weapon Accuracy", "attachment_ca_onehandmelee_accuracy",
						"One-handed Weapon Accuracy", "attachment_ca_onehandmeleeaccuracy",
						"One-handed Weapon Counter Attack", "attachment_ca_onehandmelee_counter_attack",
						"One-handed Weapon Evasion", "attachment_ca_onehandmelee_evasion",
						"One-handed Weapon Speed", "attachment_ca_onehandmelee_speed",
						"Persuasion", "attachment_ca_force_persuade",
						"Pilot Special Tactics", "attachment_ca_pilot_special_tactics",
						"Pistol Accuracy While Kneeling", "attachment_ca_pistol_kneeling",
						"Pistol Accuracy While Moving", "attachment_ca_pistol_hit_while_moving",
						"Pistol Accuracy While Prone", "attachment_ca_pistol_prone",
						"Pistol Accuracy While Standing", "attachment_ca_pistol_accuracy_while_standing",
						"Pistol Accuracy While Standing", "attachment_ca_pistol_standing",
						"Pistol Accuracy", "attachment_ca_pistol_accuracy",
						"Pistol Aiming", "attachment_ca_pistol_aim",
						"Pistol Counter Attack", "attachment_ca_pistol_counterattack",
						"Pistol Damage", "attachment_ca_pistol_damage",
						"Pistol Speed", "attachment_ca_pistol_speed",
						"Poison Absorption", "attachment_ca_absorption_poison",
						"Poison Dissipation", "attachment_ca_dissipation_poison",
						"Poison Resistance", "attachment_ca_resistance_poison",
						"Polearm Accuracy", "attachment_ca_polearm_accuracy",
						"Polearm Center Of Being Duration", "attachment_ca_center_of_being_duration_polearm",
						"Polearm Center Of Being Efficacy", "attachment_ca_polearm_center_of_being_efficacy",
						"Polearm Counter Attack", "attachment_ca_polearm_counter_attack",
						"Polearm Evasion", "attachment_ca_polearm_evasion",
						"Polearm Speed", "attachment_ca_polearm_speed",
						"Polearm Toughness", "attachment_ca_polearm_toughness",
						"Power Systems Experimentation", "attachment_ca_power_systems_experimentation",
						"Power Systems", "attachment_ca_power_systems",
						"Propulsion Reverse Engineering", "attachment_ca_propulsion_reverse",
						"Pursuasion", "attachment_ca_persuade_lie",
					},
					"R-T",
					{
						"Rally Shot Bonus", "attachment_ca_rally",
						"Ranged Defense", "attachment_ca_ranged_defense",
						"Ranged Healing Accuracy", "attachment_ca_healer_accuracy",
						"Ranged Healing Speed", "attachment_ca_healer_speed",
						"Ranged Injury Treatment Speed", "attachment_ca_healing_range_speed",
						"Regeneration", "attachment_ca_innate_regeneration",
						"Regeneration", "attachment_ca_private_innage_regeneration",
						"Regeneration", "attachment_ca_private_innate_regeneration",
						"Repair", "attachment_ca_crafting_repair",
						"Repel Creatures", "attachment_ca_camp_repel_creature",
						"Rescue", "attachment_ca_rescue",
						"Resist Creature Attacks", "attachment_ca_resist_creature_attack",
						"Resist Creature Attacks", "attachment_ca_resistcreatureattack",
						"Reverse Engineering", "attachment_ca_reverse_engineering",
						"Riding Mount", "attachment_ca_ridingmount",
						"Rifle Accuracy While Kneeling", "attachment_ca_rifle_kneeling",
						"Rifle Accuracy While Moving", "attachment_ca_rifle_hit_while_moving",
						"Rifle Accuracy While Prone", "attachment_ca_rifle_prone",
						"Rifle Accuracy While Standing", "attachment_ca_rifle_standing",
						"Rifle Accuracy", "attachment_ca_rifle_accuracy",
						"Rifle Aiming", "attachment_ca_rifle_aim",
						"Rifle Concealment Chance", "attachment_ca_rifle_concealment_chance",
						"Rifle Counterattacks", "attachment_ca_rifle_counterattack",
						"Rifle Crawl Speed", "attachment_ca_rifle_crawl",
						"Rifle Damage", "attachment_ca_rifle_damage",
						"Rifle Speed", "attachment_ca_rifle_speed",
						"Rodese (Comprehension)", "attachment_ca_language_rodian_comprehend",
						"Rodese (Speech)", "attachment_ca_language_rodian_speak",
						"Rodese", "attachment_ca_language_rodian",
						"Ryl (Comprehension)", "attachment_ca_language_twilek_comprehend",
						"Ryl (Speech)", "attachment_ca_language_twilek_speak",
						"Ryl", "attachment_ca_language_twilek",
						"Sales", "attachment_ca_sales",
						"Shield Experimentation", "attachment_ca_shields_experimentation",
						"Shields Assembly", "attachment_ca_shields_assembly",
						"Shop Sign Options", "attachment_ca_shop_sign",
						"Shyriiwook (Comprehension)", "attachment_ca_language_wookiee_comprehend",
						"Shyriiwook (Speech)", "attachment_ca_language_wookiee_speak",
						"Shyriiwook", "attachment_ca_language_wookiee",
						"Slicing", "attachment_ca_slice_market",
						"Spice Assembly", "attachment_ca_spice_assembly",
						"Spice Experimentation", "attachment_ca_spice_experimentation",
						"States Resistance", "attachment_ca_resistance_states",
						"Steady Aim Bonus", "attachment_ca_steadyaim",
						"Stored Pets", "attachment_ca_stored_pets",
						"Structure Assembly", "attachment_ca_structure_assembly",
						"Structure Complexity", "attachment_ca_structure_complexity",
						"Structure Experimentation", "attachment_ca_structure_experimentation",
						"Structure Maintenance", "attachment_ca_structure_maintenance_mod",
						"Sullustan (Comprehension)", "attachment_ca_language_sullustan_comprehend",
						"Sullustan (Speech)", "attachment_ca_language_sullustan_speak",
						"Sullustan", "attachment_ca_language_sullustan",
						"Surveying", "attachment_ca_surveying",
						"Systems Reverse Engineering", "attachment_ca_systems_reverse",
						"Taking Cover", "attachment_ca_cover",
						"Taming Vicious Creatures", "attachment_ca_tame_aggro",
						"Taming Wild Creatures", "attachment_ca_tame_non_aggro",
						"Taunt", "attachment_ca_taunt",
						"Terrain Negotiation", "attachment_ca_slope_move",
						"Thrown Weapon Accuracy", "attachment_ca_thrown_accuracy",
						"Thrown Weapon Speed", "attachment_ca_thrown_speed",
						"Tissue Assembly", "attachment_ca_tissue_assembly",
						"Tissue Experimentation", "attachment_ca_tissue_experimentation",
						"Tracking Droid Effectiveness", "attachment_ca_droid_track_chance",
						"Tracking Droids", "attachment_ca_droid_tracks",
						"Trapping", "attachment_ca_trapping",
						"Two Handed Pole Arm", "attachment_ca_twohandpolearm",
						"Two Handed Technique", "attachment_ca_twohandtechnique",
						"Two-handed Lightsaber Accuracy", "attachment_ca_twohandlightsaber_accuracy",
						"Two-handed Lightsaber Speed", "attachment_ca_twohandlightsaber_speed",
						"Two-handed Lightsaber Toughness", "attachment_ca_twohandlightsaber_toughness",
						"Two-handed Melee Accuracy", "attachment_ca_twohandmelee_accuracy",
						"Two-handed Melee Center Of Being Efficacy", "attachment_ca_twohandmelee_center_of_being_efficacy",
						"Two-handed melee Center of Being", "attachment_ca_center_of_being_duration_twohandmelee",
						"Two-handed Melee Counter Attacks", "attachment_ca_twohandmelee_counter_attack",
						"Two-handed Melee Damage", "attachment_ca_twohandedmeleedamage",
						"Two-handed Melee Damage", "attachment_ca_twohandmelee_damage",
						"Two-handed Melee Evasion", "attachment_ca_twohandmelee_evasion",
						"Two-handed Melee Speed", "attachment_ca_twohandmelee_speed",
						"Two-handed Melee Toughness", "attachment_ca_twohandmelee_toughness",
						"Two-handed Weapon Accuracy", "attachment_ca_twohandedmelee_accuracy",
						"Two-handed Weapon Counter Attack", "attachment_ca_twohandedmelee_counter_attack",
						"Two-handed Weapon Evasion", "attachment_ca_twohandedmelee_evasion",
						"Two-handed Weapon Speed", "attachment_ca_twohandedmelee_speed",
					},
					"U-Z",
					{
						"Unarmed Accuracy", "attachment_ca_unarmed_accuracy",
						"Unarmed Center Of Being Duration", "attachment_ca_center_of_being_duration_unarmed",
						"Unarmed Center Of Being Efficacy", "attachment_ca_unarmed_center_of_being_efficacy",
						"Unarmed Damage", "attachment_ca_unarmed_damage",
						"Unarmed Speed", "attachment_ca_unarmed_speed",
						"Unarmed Toughness", "attachment_ca_unarmed_toughness",
						"Vendor Item Limit", "attachment_ca_vendor_item_limit",
						"Vendors", "attachment_ca_manage_vendor",
						"Vitalize", "attachment_ca_innate_vitalize",
						"Vitalize", "attachment_ca_private_innate_vitalize",
						"Volley Fire Bonus", "attachment_ca_volley",
						"Warcry", "attachment_ca_warcry",
						"Weapon Assembly", "attachment_ca_weapon_assembly",
						"Weapon Experimentation", "attachment_ca_weapon_experimentation",
						"Weapon Repair", "attachment_ca_weapon_repair",
						"Weapon Systems Experimentation", "attachment_ca_weapon_systems_experimentation",
						"Weapon Systems", "attachment_ca_weapon_systems",
						"Wookiee Roar", "attachment_ca_innate_roar",
						"Wookiee Roar", "attachment_ca_private_innate_roar",
						"Wound Healing (Dancing)", "attachment_ca_healing_dance_wound",
						"Wound Healing (Music)", "attachment_ca_healing_music_wound",
						"Wound Healing", "attachment_ca_general_wound",
						"Wound Treatment Speed", "attachment_ca_healing_wound_speed",
						"Wound Treatment", "attachment_ca_healing_wound_treatment",
						"Zabrak (Comprehension)", "attachment_ca_language_zabrak_comprehend",
						"Zabrak (Speech)", "attachment_ca_language_zabrak_speak",
						"Zabrak", "attachment_ca_language_zabrak"
					}
				}
			},
			--"Consumables",
			...
			"Specific Testing",
			{
				"Bug Bomb", "object/weapon/ranged/grenade/grenade_bug_bomb.iff",
				"Cryoban", "object/weapon/ranged/grenade/grenade_cryoban.iff",
				"Fallback", "object/weapon/ranged/grenade/grenade_fallback.iff",
				"Frag", "object/weapon/ranged/grenade/grenade_fragmentation.iff",
				"Frag light", "object/weapon/ranged/grenade/grenade_fragmentation_light.iff",
				"Glop", "object/weapon/ranged/grenade/grenade_glop.iff",
				"Imperial Detonator", "object/weapon/ranged/grenade/grenade_imperial_detonator.iff",
				"Poison Grenade", "object/weapon/ranged/grenade/grenade_poison.iff",
