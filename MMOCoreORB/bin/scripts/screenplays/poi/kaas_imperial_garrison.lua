...
function kaas_imperial_garison:start()
	if (isZoneEnabled("kaas")) then
		print("Kaas Enabled: Spawning KIG")
		self:spawnMobiles()
	end
end
...
function kaas_imperial_garison:spawnMobiles()
	...
	spawnMobile("kaas", "dark_jedi_master", 300, 14.5, 1.0, -21.2, 0, 35791432)
  ...
  -- Dark Temple Interior
	spawnMobile("kaas", "dark_jedi_master", 900, -18.8, -2.0, 11.8, 0, 35791397)
	spawnMobile("kaas", "dark_jedi_master", 900, 2.0, -17.0, -18.8, 0, 35791397)
	spawnMobile("kaas", "dark_jedi_master", 900, 18.8, -26.5, 2.3, 0, 35791397)
	spawnMobile("kaas", "dark_jedi_master", 900, 16.3, -30.3, 16.6, -140, 35791397)
	spawnMobile("kaas", "dark_jedi_master", 900, 16.6, -21.3, -16.7, -44, 35791397)
	spawnMobile("kaas", "dark_jedi_master", 900, -16.7, -11.3, -16.8, 45, 35791397)
	spawnMobile("kaas", "dark_jedi_master", 900, 20.3, -1.3, 11.2, 90, 35791397)
	spawnMobile("kaas", "dark_jedi_master", 900, 20.4, -1.3, -11.0, -90, 35791397)
	spawnMobile("kaas", "dark_jedi_master", 900, 0.2, -1.3, -21.0, 0, 35791397)
	spawnMobile("kaas", "dark_jedi_master", 900, -0.1, -1.3, 20.5, -179, 35791397)
	spawnMobile("kaas", "dark_jedi_master", 900, -20.9, -1.3, -11.0, 90, 35791397)
	spawnMobile("kaas", "dark_jedi_master", 900, -5120.9, -81.3, -2406.3, 0, 0)
...
-- Research Facility
	...
	spawnMobile("kaas", "dark_jedi_master", 200, -71.0, -20.0, 80.7, 90, 35791466)
	...
	spawnMobile("kaas", "light_jedi_sentinel", 200, 49.8, -12.0, 64.4, 179, 35791469)
	spawnMobile("kaas", "light_jedi_sentinel", 200, 49.8, -12.0, 53.4, 0, 35791469)
	spawnMobile("kaas", "light_jedi_sentinel", 200, 56.8, -12.0, 64.4, 179, 35791469)
	spawnMobile("kaas", "light_jedi_sentinel", 200, 56.8, -12.0, 53.4, 0, 35791469)
	spawnMobile("kaas", "light_jedi_sentinel", 200, 64.8, -12.0, 64.4, 179, 35791469)
	spawnMobile("kaas", "light_jedi_sentinel", 200, 64.8, -12.0, 53.4, 0, 35791469)
	spawnMobile("kaas", "light_jedi_sentinel", 200, 72.8, -12.0, 64.4, 179, 35791469)
	spawnMobile("kaas", "light_jedi_sentinel", 200, 72.8, -12.0, 52.4, 0, 35791469)
...
--Boss 1 Trigger
	local pPadawan = spawnMobile("kaas", "dark_jedi_master", 3600, 11.7, -37.3, 0.0, -90, 35791397)
        	createObserver(OBJECTDESTRUCTION, "kaas_imperial_garison", "notifyPadawanDead", pPadawan)
--Boss 2 Trigger
	local ppPadawan = spawnMobile("kaas", "dark_jedi_master", 3600, -2.15075, -37.2976, 4.33408, 0, 35791397)
        	createObserver(OBJECTDESTRUCTION, "kaas_imperial_garison", "notifypPadawanDead", ppPadawan)
--Boss 3 Trigger
	local pppPadawan = spawnMobile("kaas", "dark_jedi_master", 3600, 15.3853, -1.2976, 23.0071, 0, 35791397)
        	createObserver(OBJECTDESTRUCTION, "kaas_imperial_garison", "notifyppPadawanDead", pppPadawan)
--Boss 4 Trigger
	local ppppPadawan = spawnMobile("kaas", "dark_jedi_master", 3600, -15.4797, -1.2976, -24.1131, 0, 35791397)
        	createObserver(OBJECTDESTRUCTION, "kaas_imperial_garison", "notifypppPadawanDead", ppppPadawan)
--Boss 5 Trigger
	local pppppPadawan = spawnMobile("kaas", "dark_jedi_master", 3600, 24.0034, -1.2976, -14.7148, 0, 35791397)
        	createObserver(OBJECTDESTRUCTION, "kaas_imperial_garison", "notifyppppPadawanDead", pppppPadawan)


end
--Phase 1 Of 5 Boss Instance [Triggered From "dark_jedi_master", [11.7, -37.3, 0.0, -90,]LOCATION OF TRIGGER] -90, 35791397]
function kaas_imperial_garison:notifyPadawanDead(pPadawan, pKiller)
	local player = LuaCreatureObject(pKiller)
        local pBoss = spawnMobile("kaas", "som_dark_jedi_boss", 0, 0.2, -37.3, -24.2, 0, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Peace is a lie, there is only passion. Through passion, I gain strength. Through strength, I gain power. Through power, I gain victory. Through victory, my chains are broken. The Force shall free me.")
	local pBoss = spawnMobile("kaas", "som_ancient_guardian_droideka", 0, -18.8, -2.0, 11.8, 0, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Intruders  Must Be Killed.")
	local pBoss = spawnMobile("kaas", "som_ancient_guardian_droideka", 0, 2.0, -17.0, -18.8, 0, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Intruders  Must Be Killed.")
	local pBoss = spawnMobile("kaas", "som_ancient_guardian_droideka", 0, 18.8, -26.5, 2.3, 0, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Intruders  Must Be Killed.")
	local pBoss = spawnMobile("kaas", "som_ancient_guardian_droideka", 0, 16.3, -30.3, 16.6, -140, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Intruders  Must Be Killed.")
	local pBoss = spawnMobile("kaas", "som_ancient_guardian_droideka", 0, -5120.9, -81.3, -2406.3, 0, 0) print("spawned POTDS")
			spatialChat(pBoss, "Intruders  Must Be Killed.")
        return 0
end
--Phase 2 Of 5 Boss Instance [Triggered From "dark_jedi_master", [-2.15075, -37.2976, 4.33408,]LOCATION OF TRIGGER] 0, 35791397]
function kaas_imperial_garison:notifypPadawanDead(ppPadawan, pKiller)
	local player = LuaCreatureObject(pKiller)
        local pBoss = spawnMobile("kaas", "som_dark_jedi_boss", 0, 0.2, -37.3, -24.2, 0, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Peace is a lie, there is only passion. Through passion, I gain strength. Through strength, I gain power. Through power, I gain victory. Through victory, my chains are broken. The Force shall free me.")
        local pBoss = spawnMobile("kaas", "hk47", 0, 0.2, -37.3, -24.2, 0, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Intruders  Must Be Killed.")
        local pBoss = spawnMobile("kaas", "hk77", 0, 0.2, -37.3, -24.2, 0, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Send For Back Up Immediately.")
	local pBoss = spawnMobile("kaas", "volcano_cyborg_lt", 0, -18.8, -2.0, 11.8, 0, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Intruders  Must Be Killed.")
	local pBoss = spawnMobile("kaas", "volcano_cyborg_lt", 0, 2.0, -17.0, -18.8, 0, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Intruders  Must Be Killed.")
	local pBoss = spawnMobile("kaas", "volcano_cyborg_lt", 0, 18.8, -26.5, 2.3, 0, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Intruders  Must Be Killed.")
	local pBoss = spawnMobile("kaas", "volcano_cyborg_lt", 0, 16.3, -30.3, 16.6, -140, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Intruders  Must Be Killed.")
	local pBoss = spawnMobile("kaas", "volcano_cyborg_lt", 900, 16.6, -21.3, -16.7, -44, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Intruders  Must Be Killed.")
        return 0
end
--Phase 3 Of 5 Boss Instance [Triggered From "dark_jedi_master", [-2.15075, -37.2976, 4.33408,]LOCATION OF TRIGGER] 0, 35791397]
function kaas_imperial_garison:notifyppPadawanDead(pppPadawan, pKiller)
	local player = LuaCreatureObject(pKiller)
        local pBoss = spawnMobile("kaas", "som_dark_jedi_boss", 0, 0.2, -37.3, -24.2, 0, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "You Have Awoken The Ancient Spirit Of Master Kah Along With His Prisoners.")
	local pBoss = spawnMobile("kaas", "master_kah", 0, -18.8, -2.0, 11.8, 0, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Intruders  Must Be Killed.")
	local pBoss = spawnMobile("kaas", "master_kah", 0, 2.0, -17.0, -18.8, 0, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Intruders  Must Be Killed.")
	local pBoss = spawnMobile("kaas", "master_kah", 0, 18.8, -26.5, 2.3, 0, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Intruders  Must Be Killed.")
	local pBoss = spawnMobile("kaas", "master_kah", 0, 16.3, -30.3, 16.6, -140, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Intruders  Must Be Killed.")
	local pBoss = spawnMobile("kaas", "master_kah", 0, 16.6, -21.3, -16.7, -44, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Intruders  Must Be Killed.")
        return 0
end
--Phase 4 Of 5 Boss Instance [Triggered From "dark_jedi_master", [-2.15075, -37.2976, 4.33408,]LOCATION OF TRIGGER] 0, 35791397]
function kaas_imperial_garison:notifypppPadawanDead(ppppPadawan, pKiller)
	local player = LuaCreatureObject(pKiller)
        local pBoss = spawnMobile("kaas", "som_dark_jedi_boss", 0, 0.2, -37.3, -24.2, 0, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Peace is a lie, there is only passion. Through passion, I gain strength. Through strength, I gain power. Through power, I gain victory. Through victory, my chains are broken. The Force shall free me.")
	local pBoss = spawnMobile("kaas", "coyn_trooper", 0, -18.8, -2.0, 11.8, 0, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Intruders  Must Be Killed.")
	local pBoss = spawnMobile("kaas", "coyn_trooper", 0, 2.0, -17.0, -18.8, 0, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Intruders  Must Be Killed.")
	local pBoss = spawnMobile("kaas", "coyn_trooper", 0, 18.8, -26.5, 2.3, 0, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Intruders  Must Be Killed.")
	local pBoss = spawnMobile("kaas", "coyn_trooper", 0, 16.3, -30.3, 16.6, -140, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Intruders  Must Be Killed.")
	local pBoss = spawnMobile("kaas", "coyn_trooper", 0, 16.6, -21.3, -16.7, -44, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Intruders  Must Be Killed.") 
        return 0
end
--Phase 5 Of 5 Boss Instance [Triggered From "dark_jedi_master", [-2.15075, -37.2976, 4.33408,]LOCATION OF TRIGGER] 0, 35791397]
function kaas_imperial_garison:notifyppppPadawanDead(pppppPadawan, pKiller)
	local player = LuaCreatureObject(pKiller)
        local pBoss = spawnMobile("kaas", "som_dark_jedi_boss", 0, 0.2, -37.3, -24.2, 0, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Peace is a lie, there is only passion. Through passion, I gain strength. Through strength, I gain power. Through power, I gain victory. Through victory, my chains are broken. The Force shall free me.")
	local pBoss = spawnMobile("kaas", "som_kenobi_historian_dark_jedi", 0, -18.8, -2.0, 11.8, 0, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Intruders  Must Be Killed.")
	local pBoss = spawnMobile("kaas", "som_kenobi_reunite_dark_trooper", 0, 2.0, -17.0, -18.8, 0, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Intruders  Must Be Killed.")
	local pBoss = spawnMobile("kaas", "som_kenobi_reunite_dark_jedi", 0, 18.8, -26.5, 2.3, 0, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Intruders  Must Be Killed.")
	local pBoss = spawnMobile("kaas", "som_kenobi_historian_dark_jedi", 0, 16.3, -30.3, 16.6, -140, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Intruders  Must Be Killed.")
	local pBoss = spawnMobile("kaas", "som_kenobi_reunite_dark_trooper", 0, 16.6, -21.3, -16.7, -44, 35791397) print("spawned POTDS")
			spatialChat(pBoss, "Intruders  Must Be Killed.") 
        return 0
end