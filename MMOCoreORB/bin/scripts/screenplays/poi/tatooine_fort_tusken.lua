...
function FortTuskenScreenPlay:spawnMobiles()
   --On top of Tusken Pool
	...
	spawnMobile("tatooine", "tusken_blood_champion",300,26.4,37.0,-0.2,-32,1189194)	
	spawnMobile("tatooine", "tusken_blood_champion",300,21.6,37.0,1.4,84,1189194)	
	spawnMobile("tatooine", "tusken_blood_champion",300,27.2,37.0,2.6,-146,1189194)	
	...
	spawnMobile("tatooine", "tusken_king",3600,-1.0,43.7,-3.3,-92,1189188)
	spawnMobile("tatooine", "tusken_executioner_quest", 1800, -0.689817, 43.7261, -5.29675, 270, 1189188)
	spawnMobile("tatooine", "tusken_executioner_quest", 1800, -0.733564, 43.7308, -0.741296, 215, 1189188)	
	...
	spawnMobile("tatooine", "tusken_berserker",3600,-3979.1,60,6248.6,-91,0)			
   ...
   --Tusken Fort Pool	
	...
	spawnMobile("tatooine", "tusken_blood_champion",180,20.8,22.9,-15.2,-102,1189183)	
